    ...
    <div className='message d-flex col-9 px-0'>
      ...
      <div className="message_right-side col-md-9 px-0 ">
        ...
        align-items-center flex-column h-100">
            <i className='message_mes-fb fab fa-facebook-messenger text-primary'
            style={{fontSize: '5rem'}}></i>
            <h4>Tin nhắn của bạn</h4>
            <h5 className='message_right-side-h5'>Gửi ảnh và tin nhắn riêng tư cho bạn bè hoặc nhóm</h5>
            <button className='message_right-side-btn' onClick={()=>setOpenModal(true)}>Gửi tin nhắn</button>
        </div>
      </div>
